...
const CHANNEL_ID = '1536592790925082724'; // Kanal 3
...
client.login(process.env.BOT_TOKEN_3)
  .then(() => console.log("[BAŞARILI] Bot 3 token doğrulandı, Discord'a bağlanıyor..."))
  .catch((err) => console.error("[CRITICAL HATA - BOT 3 LOGIN]:", err.message));
